  ...
  async fetch(request: Request, env: Env) {
    ...
    try {
      ...
      const foodImages = [
        ...
        'https://images.unsplash.com/photo-1504674900241-0877df9cc836?w=800&h=600&fit=crop&q=80',
        'https://images.unsplash.com/photo-1493770348161-369560ae357d?w=800&h=600&fit=crop&q=80',
